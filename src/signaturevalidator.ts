// src/signaturevalidator.ts
/**
 * Core SignatureValidator implementation
 */
...
export class SignatureValidator {
    private config: SignatureValidatorConfig;
    ...
    async execute(): Promise<ProcessResult> {
        ...
        try {
            if (this.config.verbose) {
                console.log('Initializing SignatureValidator processor...');
            }
